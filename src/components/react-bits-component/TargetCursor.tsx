...
// Source: src/ts-default/Animations/TargetCursor/TargetCursor.tsx
// Adapted: color props removed, cursor styled only through
// src/styles/react-bits.css. Targeting state toggles the is-targeting
...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      cursorRef.current.classList.add('is-targeting');
      ...
      const leaveHandler = () => {
        ...
        activeTarget = null;
        cursorRef.current?.classList.remove('is-targeting');
