...
// (DavidHDev/react-bits, MIT). Source: ScrollFloat TS-CSS variant.
// Adapted: tag prop added so headings keep their level, demo font sizing
// removed so type inherits the surrounding design in
// src/styles/react-bits.css.
