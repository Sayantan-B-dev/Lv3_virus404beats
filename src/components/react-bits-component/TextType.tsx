...
// (DavidHDev/react-bits, MIT). Source: TextType TS-CSS variant.
// Adapted: textColors prop removed, color comes from CSS classes in
// src/styles/react-bits.css per the pure CSS rule.
...
const TextType = ({
  ...
  const Tag = Component as unknown as React.ComponentType<TagProps>;
